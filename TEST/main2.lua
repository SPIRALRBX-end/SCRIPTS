...
-- Função para descobrir nomes disponíveis (combinando lista fixa + scan automático)
local function scanForAvailableNames()
	local foundNames = {}
	local nameSet = {}
	
	-- Primeiro, adicionar os nomes brainrot da lista fixa
	...
	-- Depois, escanear todos os ProximityPrompts no workspace para encontrar outros
...
local function updateAvailableNames()
	...
	print("Encontrados " .. #availableNames .. " nomes únicos (incluindo brainrot)")
end
...
toggleBtn.MouseButton1Click:Connect(function()
	if scrollingFR.Visible then
		...
		-- Atualizar lista de nomes disponíveis antes de abrir
