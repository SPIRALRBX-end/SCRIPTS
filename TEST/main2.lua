...
-- Função para popular o scrolling com seu estilo visual
...
local function refreshList()
	...
	local y = 0
	-- Criar entradas para cada item selecionado
	for name in pairs(selected) do
	...
	-- Atualizar canvas size se for ScrollingFrame
...
confirmBtn.MouseButton1Click:Connect(function()
	...
	-- FECHAR SELETOR E MOSTRAR LISTA
	scrollingFR.Visible = false
	confirmBtn.Visible = false
	showElementsAfterSelection()
	titleLabel.Visible = true
	...
	-- Atualizar botão principal com contador correto
	toggleBtn.Text = "🎯 SELECIONADOS (" .. count .. ")"
	toggleBtn.BackgroundColor3 = Color3.fromRGB(0, 100, 200)
	...
	print("✅ Confirmado! " .. count .. " itens selecionados")
end)
