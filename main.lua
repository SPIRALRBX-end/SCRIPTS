...
Frame.Position = UDim2.new(0.640568, 0, 0.264841, 0)
Frame.Size = UDim2.new(0.244574, 0, 0.604825, 0)
...
UIListLayout.Padding = UDim.new(0.030000, 0)
...
UIStroke_5.Color = Color3.new(0.000000, 0.000000, 0.000000)
UIStroke_5.Parent = ConfirmBtn
...
local function LocalScript_3_generatedScript()
    ...
    local function populateScrolling()
    	...
    	for _, name in ipairs(availableNames) do
    		...
    		local UIStroke = Instance.new('UIStroke')
    		btn.Name = name
    		btn.Position = UDim2.new(0.000000, 0, -0.000000, 0)
